...
import type { TConversation, ConversationListResponse } from 'podplay-build-data-provider';
                ...
                <div className="flex h-full flex-col">
                  ...
                  >
                    <div className="flex flex-1 flex-col" ref={outerContainerRef}>
                      ...
                      />
                      <div className="mt-4">
                        <a href="/gemini-studio" className="block py-2 px-4 text-blue-500 hover:bg-blue-100 rounded">
                          Gemini Studio
                        </a>
                        <a href="/gemini-vertex" className="block py-2 px-4 text-blue-500 hover:bg-blue-100 rounded">
                          Gemini Vertex
                        </a>
                      </div>
                    </div>

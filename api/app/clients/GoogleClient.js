...
// Modify EXCLUDED_GENAI_MODELS to ensure newer Gemini models are supported
const EXCLUDED_GENAI_MODELS = /gemini-(?:1\.0|1-0)$/;

// Force console log to debug Gemini model loading
console.log('Loading Google/Gemini models from client:', process.env.GOOGLE_MODELS?.split(','));
